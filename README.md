...
| File | Topic |
|------|-------|
| [dev-rules.md](dev-rules.md) | Coding-specific rules of engagement |
| [claude-code.md](claude-code.md) | Claude Code essentials — CLAUDE.md, agentic safety, session setup |
| [claude-code-reference.md](claude-code-reference.md) | Full Claude Code landscape — every file, feature, and what to configure |
| [multi-model-workflow.md](multi-model-workflow.md) | Running multiple coding models in parallel for better results |
| [codex-developer-guide.md](codex-developer-guide.md) | Technical guide for developers using Codex |
| [set-up-a-teammate-developer.md](set-up-a-teammate-developer.md) | Technical guide for the "Set up a teammate" use case |
| [build-for-ios-developer.md](build-for-ios-developer.md) | Technical guide for the "Build for iOS" use case |
...
| [ChatGPT (GPT-5.4)](https://chatgpt.com) | OpenAI | Universal truths, dev rules, prompting tricks |
