...
- "Explain this folder to me like I'm new."
- "Fix the bug where saving fails."
- "Make this email sound friendly but firm."
- "I want the simplest version that works."

---

## What helps most

- Paste the thing instead of describing it.
- Say the goal, not just the task.
- Give an example if you have one.
- Tell Codex what to avoid.
- Say whether you want a draft, a final answer, or options.
- If it is wrong, say what is wrong and why.
...
- Start with one job.
- Keep the request small if you can.
- Ask for a plan first if the task is big.
...
- You do not need to know the exact answer before asking.
