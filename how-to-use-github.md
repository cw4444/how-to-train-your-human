...
It is not usually the place you click to run the thing.
It is the project cupboard, not the finished meal.
...
- You will not usually find a `.exe` there
- You will not usually double-click something and get a finished app
...
Branches are safe copies.
Commits are save points.
And if you were expecting a big friendly download button, that is usually the sign you are looking at source code, not a packaged app.
